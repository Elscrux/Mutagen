...
namespace Mutagen.Bethesda.Oblivion
{
    ...
    [AssociatedRecordTypesAttribute(Mutagen.Bethesda.Oblivion.Internals.RecordTypeInts.ANIO)]
...
namespace Mutagen.Bethesda.Oblivion.Internals
{
    ...
    public partial class AnimatedObjectCommon : OblivionMajorRecordCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)AnimatedObject_FieldIndex.IdleAnimation) ?? true))
            {
