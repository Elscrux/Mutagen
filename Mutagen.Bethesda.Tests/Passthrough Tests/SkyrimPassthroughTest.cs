    ...
    public class SkyrimPassthroughTest : PassthroughTest
    {
        ...
        public override AlignmentRules GetAlignmentRules()
        {
            ...
            ret.AddAlignments(
                ...
                RecordTypes.LNAM,
                RecordTypes.INAM,
                new AlignmentRepeatedRule(RecordTypes.XLRM),
                RecordTypes.XMBP,
                RecordTypes.XRGD,
                RecordTypes.XRGB,
                RecordTypes.XRDS,
                new AlignmentRepeatedRule(RecordTypes.XPWR),
                new AlignmentRepeatedRule(RecordTypes.XLTW),
                RecordTypes.XEMI,
                RecordTypes.XLIG,
                RecordTypes.XALP,
                RecordTypes.XTEL,
                ...
                RecordTypes.XSPC,
                RecordTypes.XAPD,
                new AlignmentRepeatedRule(RecordTypes.XAPR),
                RecordTypes.XLIB,
                RecordTypes.XLCM,
                RecordTypes.XLCN,
                RecordTypes.XTRI,
                ...
                RecordTypes.XEZN,
                RecordTypes.XNDP,
                new AlignmentRepeatedRule(RecordTypes.XLRT),
                RecordTypes.XIS2,
                RecordTypes.XOWN,
                RecordTypes.XRNK,
                RecordTypes.XCNT,
                ...
                RecordTypes.XLRL,
                RecordTypes.XESP,
                new AlignmentRepeatedRule(RecordTypes.XLKR),
                new AlignmentSubRule(
                    ...
                    RecordTypes.SCHR,
                    RecordTypes.SCTX),
                new AlignmentRepeatedRule(RecordTypes.PDTO),
                RecordTypes.XACT,
                RecordTypes.XHTW,
                RecordTypes.XFVC,
                RecordTypes.ONAM,
