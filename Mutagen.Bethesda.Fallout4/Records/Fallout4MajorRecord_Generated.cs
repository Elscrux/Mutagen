...
namespace Mutagen.Bethesda.Fallout4
{
    #region Class
    /// <summary>
    /// Implemented by: [AcousticSpace, ActionRecord, Activator, ActorValueInformation, AnimationSoundTagSet, Armor, ArmorAddon, ArtObject, AttractionRule, Book, Cell, Class, ColorRecord, Component, Container, ADamageType, Debris, Door, EquipType, Explosion, Faction, Flora, Footstep, FootstepSet, FormList, GameSetting, Global, GodRays, Grass, HeadPart, ImpactDataSet, Ingredient, Keyword, LandscapeTexture, LensFlare, LeveledSpell, Light, LocationReferenceType, MagicEffect, MaterialSwap, MaterialType, Message, MiscItem, MoveableStatic, MusicTrack, MusicType, NavigationMesh, Npc, ObjectEffect, Outfit, Perk, PlacedObject, Quest, Race, Region, ReverbParameters, SoundDescriptor, SoundMarker, SoundOutputModel, Spell, Static, StaticCollection, TalkingActivator, Terminal, TextureSet, Transform, Tree, VoiceType, Water, Weather, Worldspace]
    /// </summary>
