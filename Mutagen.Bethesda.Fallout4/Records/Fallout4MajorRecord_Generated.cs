...
namespace Mutagen.Bethesda.Fallout4
{
    #region Class
    /// <summary>
    /// Implemented by: [AcousticSpace, ActionRecord, Activator, ActorValueInformation, Ammunition, AnimationSoundTagSet, Armor, ArmorAddon, ArtObject, AttractionRule, BodyPartData, Book, Cell, Class, ColorRecord, Component, Container, ADamageType, Debris, Door, EquipType, Explosion, Faction, Flora, Footstep, FootstepSet, FormList, Furniture, GameSetting, Global, GodRays, Grass, HeadPart, IdleMarker, ImpactDataSet, Ingestible, Ingredient, Key, Keyword, LandscapeTexture, LensFlare, LeveledItem, LeveledNpc, LeveledSpell, Light, LocationReferenceType, MagicEffect, MaterialSwap, MaterialType, Message, MiscItem, MoveableStatic, MovementType, MusicTrack, MusicType, NavigationMesh, Note, Npc, ObjectEffect, ObjectModification, Outfit, Perk, PlacedNpc, PlacedObject, APlacedTrap, Projectile, Quest, Race, Region, ReverbParameters, SoundDescriptor, SoundMarker, SoundOutputModel, Spell, Static, StaticCollection, TalkingActivator, Terminal, TextureSet, Transform, Tree, VoiceType, Water, Weapon, Weather, Worldspace]
    /// </summary>
