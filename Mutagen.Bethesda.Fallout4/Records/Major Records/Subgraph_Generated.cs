            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (ActorKeywords != null)
                {
                    ...
                    if (ActorKeywords.Specific != null)
                    {
                        ...
                        foreach (var item in ActorKeywords.Specific.WithIndex())
                        {
                ...
                if (TargetKeywords != null)
                {
                    ...
                    if (TargetKeywords.Specific != null)
                    {
                        ...
                        foreach (var item in TargetKeywords.Specific.WithIndex())
                        {
                            R mask = eval(item.Item.Value);
                            l.Add((item.Index, mask));
                        }
                ...
                if (AnimationPaths != null)
                {
                    ...
                    if (AnimationPaths.Specific != null)
                    {
                        ...
                        foreach (var item in AnimationPaths.Specific.WithIndex())
                        {
                            R mask = eval(item.Item.Value);
                            l.Add((item.Index, mask));
                        }
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class Subgraph_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "fd81b4c1-ed69-4057-bdae-9b03cf22bc26";
