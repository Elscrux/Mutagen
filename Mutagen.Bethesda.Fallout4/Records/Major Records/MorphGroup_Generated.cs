            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (MorphPresets != null)
                {
                    ...
                    if (MorphPresets.Specific != null)
                    {
                        ...
                        foreach (var item in MorphPresets.Specific.WithIndex())
                        {
                            MaskItemIndexed<R, MorphPreset.Mask<R>?>? mask = item.Item == null ? null : new MaskItemIndexed<R, MorphPreset.Mask<R>?>(item.Item.Index, eval(item.Item.Overall), item.Item.Specific?.Translate(eval));
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class MorphGroup_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "ca21e025-bf45-40da-aa3e-654a38f86848";
