            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (FilterKeywordChances != null)
                {
                    ...
                    if (FilterKeywordChances.Specific != null)
                    {
                        ...
                        foreach (var item in FilterKeywordChances.Specific.WithIndex())
                        {
                            MaskItemIndexed<R, FilterKeywordChance.Mask<R>?>? mask = item.Item == null ? null : new MaskItemIndexed<R, FilterKeywordChance.Mask<R>?>(item.Item.Index, eval(item.Item.Overall), item.Item.Specific?.Translate(eval));
                            if (mask == null) continue;
                            l.Add(mask);
                        }
                    }
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        ILeveledItemGetter
    {
        ...
        public ITranslatedStringGetter? OverrideName => _OverrideNameLocation.HasValue ? StringBinaryTranslation.Instance.Parse(HeaderTranslation.ExtractSubrecordMemory(_data, _OverrideNameLocation.Value, _package.MetaData.Constants), StringsSource.DL, _package.MetaData.StringsLookup) : default(TranslatedString?);
        #endregion
