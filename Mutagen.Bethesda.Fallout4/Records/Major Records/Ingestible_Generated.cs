...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<Ingestible>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IPreviewTransformGetter IIngestibleGetter.PreviewTransform => PreviewTransform;
        #endregion
        #region Name
        /// <summary>
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class IngestibleCommon : Fallout4MajorRecordCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)Ingestible_FieldIndex.PreviewTransform) ?? true))
            {
                ...
                {
                    if (!((PreviewTransformCommon)((IPreviewTransformGetter)lhsPreviewTransform).CommonInstance()!).Equals(lhsPreviewTransform, rhsPreviewTransform, crystal?.GetSubCrystal((int)Ingestible_FieldIndex.PreviewTransform))) return false;
                }
    ...
    public partial class IngestibleSetterTranslationCommon : Fallout4MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                errorMask?.PushIndex((int)Ingestible_FieldIndex.PreviewTransform);
                try
                {
                    if ((copyMask?.GetShouldTranslate((int)Ingestible_FieldIndex.PreviewTransform) ?? true))
                    {
                        item.PreviewTransform = rhs.PreviewTransform.DeepCopy(
                            copyMask: copyMask?.GetSubCrystal((int)Ingestible_FieldIndex.PreviewTransform),
                            errorMask: errorMask);
                    }
                }
                catch (Exception ex)
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IIngestibleGetter
    {
        ...
        public ITranslatedStringGetter? AddictionName => _AddictionNameLocation.HasValue ? StringBinaryTranslation.Instance.Parse(HeaderTranslation.ExtractSubrecordMemory(_data, _AddictionNameLocation.Value, _package.MetaData.Constants), StringsSource.DL, _package.MetaData.StringsLookup) : default(TranslatedString?);
        #endregion
