            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Placements != null)
                {
                    ...
                    if (Placements.Specific != null)
                    {
                        ...
                        foreach (var item in Placements.Specific.WithIndex())
                        {
                            MaskItemIndexed<R, Placement.Mask<R>?>? mask = item.Item == null ? null : new MaskItemIndexed<R, Placement.Mask<R>?>(item.Item.Index, eval(item.Item.Overall), item.Item.Specific?.Translate(eval));
