...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class MagicEffectCommon : Fallout4MajorRecordCommon
    {
            ...
            MagicEffect.Mask<bool>? printMask = null)
        {
            ...
            if (printMask?.MagicSkill ?? true)
            {
                fg.AppendItem(item.MagicSkill.FormKey, "MagicSkill");
            }
            if (printMask?.ResistValue ?? true)
            {
                fg.AppendItem(item.ResistValue.FormKey, "ResistValue");
            }
            if (printMask?.CounterEffectCount ?? true)
            {
            ...
            if (printMask?.SecondActorValue ?? true)
            {
                fg.AppendItem(item.SecondActorValue.FormKey, "SecondActorValue");
            }
            if (printMask?.CastingArt ?? true)
            {
        ...
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(IMagicEffectGetter obj)
        {
            ...
            foreach (var item in obj.Archetype.ContainedFormLinks)
            {
                yield return item;
            }
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IMagicEffectGetter
    {
        ...
        public IFormLinkGetter<IActorValueInformationGetter> MagicSkill => _MagicSkill_IsSet ? new FormLink<IActorValueInformationGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(_MagicSkillLocation, 0x4)))) : FormLink<IActorValueInformationGetter>.Null;
        #endregion
        #region ResistValue
        private int _ResistValueLocation => _DATALocation!.Value + 0x10;
        private bool _ResistValue_IsSet => _DATALocation.HasValue;
        public IFormLinkGetter<IActorValueInformationGetter> ResistValue => _ResistValue_IsSet ? new FormLink<IActorValueInformationGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(_ResistValueLocation, 0x4)))) : FormLink<IActorValueInformationGetter>.Null;
        #endregion
        #region CounterEffectCount
        ...
        public IFormLinkGetter<IActorValueInformationGetter> SecondActorValue => _SecondActorValue_IsSet ? new FormLink<IActorValueInformationGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(_data.Span.Slice(_SecondActorValueLocation, 0x4)))) : FormLink<IActorValueInformationGetter>.Null;
        #endregion
        #region CastingArt
