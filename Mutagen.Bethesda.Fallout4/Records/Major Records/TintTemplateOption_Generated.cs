            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (TemplateColors != null)
                {
                    ...
                    if (TemplateColors.Specific != null)
                    {
                        ...
                        foreach (var item in TemplateColors.Specific.WithIndex())
                        {
                            MaskItemIndexed<R, TintTemplateColor.Mask<R>?>? mask = item.Item == null ? null : new MaskItemIndexed<R, TintTemplateColor.Mask<R>?>(item.Item.Index, eval(item.Item.Overall), item.Item.Specific?.Translate(eval));
                            if (mask == null) continue;
                            l.Add(mask);
                        }
                    }
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class TintTemplateOption_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "f4e4e031-a4d8-46cd-ae83-fdf911dc0d13";
