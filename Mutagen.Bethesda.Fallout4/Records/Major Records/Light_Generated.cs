...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<Light>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IPreviewTransformGetter ILightGetter.PreviewTransform => PreviewTransform;
        #endregion
        #region Model
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                ...
                try
                {
                    if ((copyMask?.GetShouldTranslate((int)Light_FieldIndex.PreviewTransform) ?? true))
                    {
                        item.PreviewTransform = rhs.PreviewTransform.DeepCopy(
                            copyMask: copyMask?.GetSubCrystal((int)Light_FieldIndex.PreviewTransform),
                            errorMask: errorMask);
                    }
                }
                catch (Exception ex)
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        ILightGetter
    {
        ...
        public String? Gobo => _GoboLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _GoboLocation.Value, _package.MetaData.Constants)) : default(string?);
        #endregion
        #region Lens
