...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<Door>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IPreviewTransformGetter IDoorGetter.PreviewTransform => PreviewTransform;
        #endregion
        #region Name
        /// <summary>
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class DoorCommon : Fallout4MajorRecordCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)Door_FieldIndex.PreviewTransform) ?? true))
            {
                ...
                {
                    if (!((PreviewTransformCommon)((IPreviewTransformGetter)lhsPreviewTransform).CommonInstance()!).Equals(lhsPreviewTransform, rhsPreviewTransform, crystal?.GetSubCrystal((int)Door_FieldIndex.PreviewTransform))) return false;
                }
    ...
    public partial class DoorSetterTranslationCommon : Fallout4MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                errorMask?.PushIndex((int)Door_FieldIndex.PreviewTransform);
                try
                {
                    if ((copyMask?.GetShouldTranslate((int)Door_FieldIndex.PreviewTransform) ?? true))
                    {
                        item.PreviewTransform = rhs.PreviewTransform.DeepCopy(
                            copyMask: copyMask?.GetSubCrystal((int)Door_FieldIndex.PreviewTransform),
                            errorMask: errorMask);
                    }
                }
                catch (Exception ex)
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IDoorGetter
    {
        ...
        public ITranslatedStringGetter? AlternateTextOpen => _AlternateTextOpenLocation.HasValue ? StringBinaryTranslation.Instance.Parse(HeaderTranslation.ExtractSubrecordMemory(_data, _AlternateTextOpenLocation.Value, _package.MetaData.Constants), StringsSource.DL, _package.MetaData.StringsLookup) : default(TranslatedString?);
        #endregion
        #region AlternateTextClose
        private int? _AlternateTextCloseLocation;
        public ITranslatedStringGetter? AlternateTextClose => _AlternateTextCloseLocation.HasValue ? StringBinaryTranslation.Instance.Parse(HeaderTranslation.ExtractSubrecordMemory(_data, _AlternateTextCloseLocation.Value, _package.MetaData.Constants), StringsSource.DL, _package.MetaData.StringsLookup) : default(TranslatedString?);
        #endregion
