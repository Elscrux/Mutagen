...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMiscItemInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IPreviewTransformGetter IMiscItemGetter.PreviewTransform => PreviewTransform;
        #endregion
        #region Name
        /// <summary>
            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Components != null)
                {
                    ...
                    if (Components.Specific != null)
                    {
                        ...
                        foreach (var item in Components.Specific.WithIndex())
                        {
                            MaskItemIndexed<R, MiscItemComponent.Mask<R>?>? mask = item.Item == null ? null : new MaskItemIndexed<R, MiscItemComponent.Mask<R>?>(item.Item.Index, eval(item.Item.Overall), item.Item.Specific?.Translate(eval));
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class MiscItemCommon : Fallout4MajorRecordCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)MiscItem_FieldIndex.PreviewTransform) ?? true))
            {
                ...
                {
                    if (!((PreviewTransformCommon)((IPreviewTransformGetter)lhsPreviewTransform).CommonInstance()!).Equals(lhsPreviewTransform, rhsPreviewTransform, crystal?.GetSubCrystal((int)MiscItem_FieldIndex.PreviewTransform))) return false;
                }
    ...
    public partial class MiscItemSetterTranslationCommon : Fallout4MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                errorMask?.PushIndex((int)MiscItem_FieldIndex.PreviewTransform);
                try
                {
                    if ((copyMask?.GetShouldTranslate((int)MiscItem_FieldIndex.PreviewTransform) ?? true))
                    {
                        item.PreviewTransform = rhs.PreviewTransform.DeepCopy(
                            copyMask: copyMask?.GetSubCrystal((int)MiscItem_FieldIndex.PreviewTransform),
                            errorMask: errorMask);
                    }
                }
                catch (Exception ex)
