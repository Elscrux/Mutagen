...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMovementDirectionData
    {
        ...
        public void ToString(
            ...
            string? name = null)
        {
            MovementDirectionDataMixIn.ToString(
                item: this,
                name: name);
        }
            ...
            IMask<TItem>
        {
            ...
            public string ToString(MovementDirectionData.Mask<bool>? printMask = null)
            {
            ...
            public void ToString(FileGeneration fg, MovementDirectionData.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(MovementDirectionData.Mask<TItem>)} =>");
                fg.AppendLine("[");
    ...
    public static partial class MovementDirectionDataMixIn
    {
        ...
        {
            return ((MovementDirectionDataCommon)((IMovementDirectionDataGetter)item).CommonInstance()!).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            MovementDirectionData.Mask<bool>? printMask = null)
        {
            ((MovementDirectionDataCommon)((IMovementDirectionDataGetter)item).CommonInstance()!).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class MovementDirectionData_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "c44d7dd2-2bd5-4521-b5e6-67e8ca98e89e";
    ...
    public partial class MovementDirectionDataCommon
    {
            ...
            MovementDirectionData.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"MovementDirectionData =>");
            }
            else
            {
                fg.AppendLine($"{name} (MovementDirectionData) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> GetContainedFormLinks(IMovementDirectionDataGetter obj)
        {
            yield break;
        }
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IMovementDirectionDataGetter
    {
        ...
        public Single Walk => _data.Slice(0x4, 0x4).Float();
        public Single Run => _data.Slice(0x8, 0x4).Float();
        ...
        public static MovementDirectionDataBinaryOverlay MovementDirectionDataFactory(
            OverlayStream stream,
            BinaryOverlayFactoryPackage package,
