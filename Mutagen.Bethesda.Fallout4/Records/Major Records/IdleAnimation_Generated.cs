...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IIdleAnimationGetter
    {
        ...
        public String? BehaviorGraph => _BehaviorGraphLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _BehaviorGraphLocation.Value, _package.MetaData.Constants)) : default(string?);
        #endregion
        #region AnimationEvent
        ...
        public String? AnimationFile => _AnimationFileLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _AnimationFileLocation.Value, _package.MetaData.Constants)) : default(string?);
        #endregion
