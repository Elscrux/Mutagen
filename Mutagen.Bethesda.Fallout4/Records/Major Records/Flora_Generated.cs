...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<Flora>
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IPreviewTransformGetter IFloraGetter.PreviewTransform => PreviewTransform;
        #endregion
        #region Name
        /// <summary>
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IPropertiesGetter? IFloraGetter.Properties => this.Properties;
        #endregion
        #region PNAM
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class FloraCommon : Fallout4MajorRecordCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)Flora_FieldIndex.PreviewTransform) ?? true))
            {
                ...
                {
                    if (!((PreviewTransformCommon)((IPreviewTransformGetter)lhsPreviewTransform).CommonInstance()!).Equals(lhsPreviewTransform, rhsPreviewTransform, crystal?.GetSubCrystal((int)Flora_FieldIndex.PreviewTransform))) return false;
                }
            ...
            if ((crystal?.GetShouldTranslate((int)Flora_FieldIndex.Properties) ?? true))
            {
                ...
                {
                    if (!((PropertiesCommon)((IPropertiesGetter)lhsProperties).CommonInstance()!).Equals(lhsProperties, rhsProperties, crystal?.GetSubCrystal((int)Flora_FieldIndex.Properties))) return false;
                }
    ...
    public partial class FloraSetterTranslationCommon : Fallout4MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                errorMask?.PushIndex((int)Flora_FieldIndex.PreviewTransform);
                try
                {
                    if ((copyMask?.GetShouldTranslate((int)Flora_FieldIndex.PreviewTransform) ?? true))
                    {
                        item.PreviewTransform = rhs.PreviewTransform.DeepCopy(
                            copyMask: copyMask?.GetSubCrystal((int)Flora_FieldIndex.PreviewTransform),
                            errorMask: errorMask);
                    }
                }
                catch (Exception ex)
                ...
                try
                {
                    if(rhs.Properties is {} rhsProperties)
                    {
                        item.Properties = rhsProperties.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)Flora_FieldIndex.Properties));
                    }
                    else
                    {
