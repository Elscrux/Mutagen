...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class Race_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "aaa9e97a-079f-4344-a679-8513c0140787";
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IRaceGetter
    {
        ...
        public String? HairColorLookupTexture => _HairColorLookupTextureLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _HairColorLookupTextureLocation.Value, _package.MetaData.Constants)) : default(string?);
        #endregion
        #region HairColorExtendedLookupTexture
        private int? _HairColorExtendedLookupTextureLocation;
        public String? HairColorExtendedLookupTexture => _HairColorExtendedLookupTextureLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _HairColorExtendedLookupTextureLocation.Value, _package.MetaData.Constants)) : default(string?);
        #endregion
        #region DialogueQuest
