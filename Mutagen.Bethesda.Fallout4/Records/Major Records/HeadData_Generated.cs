            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (TintLayers != null)
                {
                    ...
                    if (TintLayers.Specific != null)
                    {
                        ...
                        {
                            MaskItemIndexed<R, TintGroup.Mask<R>?>? mask = item.Item == null ? null : new MaskItemIndexed<R, TintGroup.Mask<R>?>(item.Item.Index, eval(item.Item.Overall), item.Item.Specific?.Translate(eval));
                            if (mask == null) continue;
                            l.Add(mask);
                        }
                    }
                ...
                if (MorphGroups != null)
                {
                    ...
                    if (MorphGroups.Specific != null)
                    {
                        ...
                        foreach (var item in MorphGroups.Specific.WithIndex())
                        {
                            MaskItemIndexed<R, MorphGroup.Mask<R>?>? mask = item.Item == null ? null : new MaskItemIndexed<R, MorphGroup.Mask<R>?>(item.Item.Index, eval(item.Item.Overall), item.Item.Specific?.Translate(eval));
                            if (mask == null) continue;
                            l.Add(mask);
                        }
                    }
                ...
                if (FaceMorphs != null)
                {
                    ...
                    if (FaceMorphs.Specific != null)
                    {
                        ...
                        foreach (var item in FaceMorphs.Specific.WithIndex())
                        {
                            MaskItemIndexed<R, FaceMorph.Mask<R>?>? mask = item.Item == null ? null : new MaskItemIndexed<R, FaceMorph.Mask<R>?>(item.Item.Index, eval(item.Item.Overall), item.Item.Specific?.Translate(eval));
                            if (mask == null) continue;
                            l.Add(mask);
                        }
                    }
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class HeadData_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "2e981741-561b-49d6-920a-90f9f5c5c10a";
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IHeadDataGetter
    {
        ...
        public String? MaleWrinkleMapPath => _MaleWrinkleMapPathLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _MaleWrinkleMapPathLocation.Value, _package.MetaData.Constants)) : default(string?);
        #endregion
