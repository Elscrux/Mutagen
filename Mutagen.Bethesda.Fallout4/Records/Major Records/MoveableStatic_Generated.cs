...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        IMoveableStaticInternal
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IPreviewTransformGetter IMoveableStaticGetter.PreviewTransform => PreviewTransform;
        #endregion
        #region Name
        /// <summary>
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IPropertiesGetter? IMoveableStaticGetter.Properties => this.Properties;
        #endregion
        #region OnLocalMap
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class MoveableStaticCommon : Fallout4MajorRecordCommon
    {
            ...
            TranslationCrystal? crystal)
        {
            ...
            if ((crystal?.GetShouldTranslate((int)MoveableStatic_FieldIndex.PreviewTransform) ?? true))
            {
                ...
                {
                    if (!((PreviewTransformCommon)((IPreviewTransformGetter)lhsPreviewTransform).CommonInstance()!).Equals(lhsPreviewTransform, rhsPreviewTransform, crystal?.GetSubCrystal((int)MoveableStatic_FieldIndex.PreviewTransform))) return false;
                }
            ...
            if ((crystal?.GetShouldTranslate((int)MoveableStatic_FieldIndex.Properties) ?? true))
            {
                ...
                {
                    if (!((PropertiesCommon)((IPropertiesGetter)lhsProperties).CommonInstance()!).Equals(lhsProperties, rhsProperties, crystal?.GetSubCrystal((int)MoveableStatic_FieldIndex.Properties))) return false;
                }
    ...
    public partial class MoveableStaticSetterTranslationCommon : Fallout4MajorRecordSetterTranslationCommon
    {
            ...
            bool deepCopy)
        {
            ...
            {
                errorMask?.PushIndex((int)MoveableStatic_FieldIndex.PreviewTransform);
                try
                {
                    if ((copyMask?.GetShouldTranslate((int)MoveableStatic_FieldIndex.PreviewTransform) ?? true))
                    {
                        item.PreviewTransform = rhs.PreviewTransform.DeepCopy(
                            copyMask: copyMask?.GetSubCrystal((int)MoveableStatic_FieldIndex.PreviewTransform),
                            errorMask: errorMask);
                    }
                }
                catch (Exception ex)
                ...
                try
                {
                    if(rhs.Properties is {} rhsProperties)
                    {
                        item.Properties = rhsProperties.DeepCopy(
                            errorMask: errorMask,
                            copyMask?.GetSubCrystal((int)MoveableStatic_FieldIndex.Properties));
                    }
                    else
                    {
