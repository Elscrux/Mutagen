...
namespace Mutagen.Bethesda.Fallout4
{
        ...
        ILoquiObjectSetter<ArmorAddonModel>
    {
            ...
            IMask<TItem>
        {
            ...
            public string ToString(ArmorAddonModel.Mask<bool>? printMask = null)
            {
            ...
            public void ToString(FileGeneration fg, ArmorAddonModel.Mask<bool>? printMask = null)
            {
                fg.AppendLine($"{nameof(ArmorAddonModel.Mask<TItem>)} =>");
                fg.AppendLine("[");
                using (new DepthWrapper(fg))
                {
                    ...
                    {
                        fg.AppendItem(AddonModel, "AddonModel");
                    }
                }
                fg.AppendLine("]");
            }
        ...
        #region Mutagen
        public IEnumerable<IFormLinkGetter> ContainedFormLinks => ArmorAddonModelCommon.Instance.GetContainedFormLinks(this);
    ...
    public static partial class ArmorAddonModelMixIn
    {
        ...
        {
            return ((ArmorAddonModelCommon)((IArmorAddonModelGetter)item).CommonInstance()!).ToString(
                item: item,
                name: name,
                printMask: printMask);
        }
        ...
        public static void ToString(
            ...
            ArmorAddonModel.Mask<bool>? printMask = null)
        {
            ((ArmorAddonModelCommon)((IArmorAddonModelGetter)item).CommonInstance()!).ToString(
                item: item,
                fg: fg,
                name: name,
                printMask: printMask);
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class ArmorAddonModelSetterCommon
    {
            ...
            TypedParseParams? translationParams = null)
        {
            PluginUtilityTranslation.SubrecordParse(
                ...
                frame: frame,
                translationParams: translationParams,
                fillStructs: ArmorAddonModelBinaryCreateTranslation.FillBinaryStructs,
    ...
    public partial class ArmorAddonModelCommon
    {
            ...
            ArmorAddonModel.Mask<bool>? printMask = null)
        {
            if (name == null)
            {
                fg.AppendLine($"ArmorAddonModel =>");
            }
            else
            {
                fg.AppendLine($"{name} (ArmorAddonModel) =>");
            }
            fg.AppendLine("[");
            using (new DepthWrapper(fg))
            {
            ...
            ArmorAddonModel.Mask<bool>? printMask = null)
        {
            ...
            {
                fg.AppendItem(AddonIndexItem, "AddonIndex");
            }
            if (printMask?.AddonModel ?? true)
            {
                fg.AppendItem(item.AddonModel.FormKeyNullable, "AddonModel");
            }
        }
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    {
        public readonly static ArmorAddonModelBinaryWriteTranslation Instance = new ArmorAddonModelBinaryWriteTranslation();
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IArmorAddonModelGetter
    {
        ...
        public UInt16? AddonIndex => _AddonIndexLocation.HasValue ? BinaryPrimitives.ReadUInt16LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_data, _AddonIndexLocation.Value, _package.MetaData.Constants)) : default(UInt16?);
        #endregion
        #region AddonModel
        private int? _AddonModelLocation;
        public IFormLinkNullableGetter<IArmorAddonGetter> AddonModel => _AddonModelLocation.HasValue ? new FormLinkNullable<IArmorAddonGetter>(FormKey.Factory(_package.MetaData.MasterReferences!, BinaryPrimitives.ReadUInt32LittleEndian(HeaderTranslation.ExtractSubrecordMemory(_data, _AddonModelLocation.Value, _package.MetaData.Constants)))) : FormLinkNullable<IArmorAddonGetter>.Null;
        #endregion
