            ...
            protected void Translate_InternalFill<R>(Mask<R> obj, Func<TItem, R> eval)
            {
                ...
                if (Options != null)
                {
                    ...
                    if (Options.Specific != null)
                    {
                        ...
                        foreach (var item in Options.Specific.WithIndex())
                        {
                            MaskItemIndexed<R, TintTemplateOption.Mask<R>?>? mask = item.Item == null ? null : new MaskItemIndexed<R, TintTemplateOption.Mask<R>?>(item.Item.Index, eval(item.Item.Overall), item.Item.Specific?.Translate(eval));
...
namespace Mutagen.Bethesda.Fallout4.Internals
{
    ...
    public partial class TintGroup_Registration : ILoquiRegistration
    {
        ...
        public const string GUID = "9db98b22-e068-42df-ba60-b4be28392821";
