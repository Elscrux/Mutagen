...
namespace Mutagen.Bethesda.Fallout4.Internals
{
        ...
        IMessageGetter
    {
        ...
        public String? SWF => _SWFLocation.HasValue ? BinaryStringUtility.ProcessWholeToZString(HeaderTranslation.ExtractSubrecordMemory(_data, _SWFLocation.Value, _package.MetaData.Constants)) : default(string?);
        #endregion
        #region ShortTitle
        private int? _ShortTitleLocation;
        public ITranslatedStringGetter? ShortTitle => _ShortTitleLocation.HasValue ? StringBinaryTranslation.Instance.Parse(HeaderTranslation.ExtractSubrecordMemory(_data, _ShortTitleLocation.Value, _package.MetaData.Constants), StringsSource.DL, _package.MetaData.StringsLookup) : default(TranslatedString?);
        #endregion
